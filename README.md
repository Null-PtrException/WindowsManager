...
MinGW编译命令：g++ -O3 -Os -mwindows -static -s -ffunction-sections -fdata-sections -Wl,--gc-sections -Wl,--strip-all WindowsManager.cpp -lcomctl32 -lshlwapi -lgdi32 -luser32 -lkernel32 -lole32 -luuid -o WindowsManager.exe
...
*注：这个命令需要搭配sudo提权使用，即把Nsudo放在根目录下（也可以直接用Enigma Virtual Box合体）
